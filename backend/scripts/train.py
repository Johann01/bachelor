...
class TSModel(nn.Module):
    def __init__(self, n_features, n_hidden=64, n_layers=2):
        ...
        self.lstm = nn.LSTM(
            input_size=n_features, hidden_size=n_hidden, batch_first=True, num_layers=n_layers, dropout=0.5
        )
...
if __name__ == "__main__":
    ...
    train_model(train_df, test_df, label_name, args.sequence_length, args.batch_size, args.n_epochs, args.n_epochs_stop)
